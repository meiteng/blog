	...
	<div class="main-container-inner">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<button class="btn btn-success" onclick="redirctUrl('admin/findTypes/add')">添加发现类型</button>
				<!-- 虚线分割 -->
				<div class="hr hr-18 dotted hr-double"></div>
				<!-- PAGE CONTENT BEGINS -->
				<div class="row">
										...
										<tr class="even">
											...
											<td class="">
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													<a class="green" href="${pageContext.request.contextPath}/admin/findTypes/update?id=${item.id}">
														<i class="icon-pencil bigger-130"></i>
													</a>
													<a class="red" href="${pageContext.request.contextPath}/admin/findTypes/delete?id=${item.id}">
