			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 添加的form表单 -->
						<form class="form-horizontal" id="validation-form" action="${pageContext.request.contextPath}/admin/resourcesinner/doAdd"
							method="post">
							<input type="hidden" name="resourcesid" value="${resourcesId}" />
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">识别图名称:</label>
							...
							<input type="hidden" value="" name="identificationUrl" /> <input type="hidden" value="" name="androidUrl" /> <input
								type="hidden" value="" name="iosUrl" />
						</form>

						<div style="clear: both;"></div>
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" style="text-align: right;" for="name">上传识别图:</label>
							<div class="col-xs-12 col-sm-9">
						...
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" style="text-align: right;" for="name">上传安卓资源包:</label>
							<div class="col-xs-12 col-sm-9">
								<div id="dropzone4" style="font-size: 14px;">
									<form enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/admin/upload" id="dropzone_url"
										class="dropzone" style="width: 400px; min-height: 250px;" name="form" method="post">
										<div class="fallback">
											<input type="hidden" name="dirName" value="resourcesinner" /> <input name="file" type="file" multiple />
										</div>
									</form>
								</div>
							</div>
