			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 添加的form表单 -->
						<form class="form-horizontal" id="validation-form" action="${pageContext.request.contextPath}/admin/companymanage/doUpdate" method="post">

							<input type="hidden" name="apptoken" value="${detail.apptoken}" />
							...
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">修改公司名字:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" value="${detail.companyName}" name="companyName" class="col-xs-12 col-sm-5" />
									</div>
								</div>
							</div>
                            <br>
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">修改公司地址:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" value="${detail.address}" name="address" class="col-xs-12 col-sm-5" style="width: 600px;" />
									</div>
								</div>
							</div>
							<br>
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">修改公司电话:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" value="${detail.contact}" name="contact" class="col-xs-12 col-sm-5" style="width: 600px;" />
									</div>
								</div>
							</div>
							...
							<br>
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">修改公司注册信息:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" value="${detail.registerNum}" name="registerNum" class="col-xs-12 col-sm-5" style="width: 600px;" />
									</div>
								</div>
							</div>
							<%-- <div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">修改公司唯一密钥:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" value="${detail.apptoken}" name="desc" class="col-xs-12 col-sm-5" style="width: 600px;" />
									</div>
								</div>
							</div> --%>
