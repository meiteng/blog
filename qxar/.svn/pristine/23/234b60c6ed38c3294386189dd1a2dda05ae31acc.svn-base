			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 添加的form表单 -->
						<form class="form-horizontal" id="validation-form" action="${pageContext.request.contextPath}/admin/article/doUpdate" method="post">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="title" value="${detail.title}" class="col-xs-12 col-sm-5" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">创建时间:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="addtime" value="${detail.addtime}" class="col-xs-12 col-sm-5" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<script id="editor" name="content" value="${detail.content}" type="text/plain" style="width: 800px; height: 500px;"></script>
									</div>
								</div>
							</div>
							<div class="space-2"></div>
							...
							<input type="hidden" value="${detail.img_url}" name="imgUrl" />
	...
	$(document).ready(function() {
		...
		$('#validation-form').validate({
			...
			messages : {
				title : {
					required : "请输入文章标题",
					minlength : "文章标题为4—20个字符",
					maxlength : "文章标题为4—20个字符"
				},
				addtime : {
					required : "请输入创建时间，格式为'yyyy-MM-dd''",
				},
				content : {
					required : "请输入文章内容",
				},
