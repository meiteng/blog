			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 添加的form表单 -->
						<form class="form-horizontal" id="validation-form" action="${pageContext.request.contextPath}/admin/resourcesinner/doUpdate" method="post">
							...
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">修改资源id:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
							...
							<input type="hidden" value="${detail.identificationUrl}" name="identificationUrl" />
							
							<input type="hidden" value="${detail.allResources}" name="allResources" />
						...
						<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" value="${detail.identificationName}" name="identificationName" class="col-xs-12 col-sm-5" style="width: 600px;" />
									</div>
								</div>
							</div>
						<div style="clear:both;"></div>
						<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" style="text-align: right;" for="name">修改资源包名字:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" value="${detail.resourcesName}" name="resourcesName" class="col-xs-12 col-sm-5" style="width: 600px;" />
									</div>
								</div>
							</div>
						</form>
                      ...
                      <div style="clear:both;"></div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div id="dropzone4" style="font-size: 14px;">
									...
									<div style="float:left;margin-left: 15px;text-align: center;width:200px;padding-top: 40px;">
										<span>原图：</span><a href="${pageContext.request.contextPath}/${detail.imgUrl}" target="_blank"><img src="${pageContext.request.contextPath}/${detail.imgUrl}" style="width:100%;margin-top:10px;max-height:180px;"/></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div style="clear:both;"></div>
			        <div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" style="text-align: right;" for="name">修改识别图:</label>
							<div class="col-xs-12 col-sm-9">
								<div id="dropzone4" style="font-size: 14px;">
									<form enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/admin/upload" id="identificationUrl1"
										class="dropzone" style="width: 400px; min-height: 250px;float:left;" name="form" method="post">
										<div class="fallback">
											<input type="hidden" name="dirName" value="resources" /> <input name="file" type="file" multiple />
										</div>
									...
									<div style="float:left;margin-left: 15px;text-align: center;width:200px;padding-top: 40px;">
										<span>原图：</span><a href="${pageContext.request.contextPath}/${detail.identificationUrl}" target="_blank"><img src="${pageContext.request.contextPath}/${detail.identificationUrl}" style="width:100%;margin-top:10px;max-height:180px;"/></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div style="clear:both;"></div>
					 <div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" style="text-align: right;" for="name">重新上传资源包:</label>
							<div class="col-xs-12 col-sm-9">
								<div id="dropzone4" style="font-size: 14px;">
									<form enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/admin/upload" id="allResources1"
										class="dropzone" style="width: 400px; min-height: 250px;float:left;" name="form" method="post">
										<div class="fallback">
											<input type="hidden" name="dirName" value="resources" /> <input name="file" type="file" multiple />
										</div>
									...
									<div style="float:left;margin-left: 15px;text-align: center;width:200px;padding-top: 40px;">
										<span>原图：</span><a href="${pageContext.request.contextPath}/${detail.allResources}" target="_blank"><img src="${pageContext.request.contextPath}/${detail.allResources}" style="width:100%;margin-top:10px;max-height:180px;"/></a>
									</div>
								</div>
							</div>
						</div>
		...
		try {
			$("#allResources1").dropzone({
				...
				complete : function(response) {
					...
					if (response != null && response.status == "success") {
						var returnObj = eval("(" + response.xhr.response + ")");
						$("input[name='allResources']").val(returnObj.o);
					}
