			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 添加的form表单 -->
						<form class="form-horizontal" id="validation-form" action="${pageContext.request.contextPath}/admin/find/doAdd" method="post">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="tags" class="col-xs-12 col-sm-5" />
									</div>
								</div>
							</div>
							<div class="space-2"></div>
							...
							<!-- 资源别名 -->
							<input type="hidden" value="" name="identificationName" />
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" id="identificationName" value="" class="col-xs-12 col-sm-5" />
									</div>
								</div>
							</div>
						</div>
