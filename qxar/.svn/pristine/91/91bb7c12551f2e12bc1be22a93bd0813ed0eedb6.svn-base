			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 添加的form表单 -->
						<form class="form-horizontal" id="validation-form" action="${pageContext.request.contextPath}/admin/resources/doAdd"
							method="post">

							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">资源标题:</label>
							...
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">摘要:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="desc" class="col-xs-12 col-sm-5" />
									</div>
								</div>
							</div>
							<div class="space-2"></div>
							<input type="hidden" value="" name="imgUrl" /> <input type="hidden" value="" name="identificationUrl" />

							<!-- 发现内容--HTML文本 -->
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">添加内容:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
							...
							<div class="form-group">
								<label class="control-label col-xs-12 col-sm-3 no-padding-right" style="text-align: right;" for="name">识别图名字:</label>
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="identificationName" class="col-xs-12 col-sm-5" />
									</div>
								</div>
							</div>
						...
						<div style="clear: both;"></div>
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" style="text-align: right;" for="name">上传封面识别图:</label>
							<div class="col-xs-12 col-sm-9">
								<div id="dropzone5" style="font-size: 14px;">
									<form enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/admin/upload" id="dropzone_url1"
										class="dropzone" style="width: 400px; min-height: 250px;" name="form" method="post">
										<div class="fallback">
											<input type="hidden" name="dirName" value="resources" /> <input name="file" type="file" multiple />
										</div>
