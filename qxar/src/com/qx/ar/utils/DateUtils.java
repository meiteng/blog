...
public class DateUtils {
	...
	public static String getLastWeekDay(java.util.Date theDate) {
		...
		calendar.setFirstDayOfWeek(Calendar.MONDAY);
		calendar.set(Calendar.DAY_OF_WEEK, Calendar.MONDAY);
		return DateUtils.format(new Date(calendar.getTime().getTime() + (6 * 24 * 60 * 60 * 1000)), "yyyy-MM-dd")
				+ " 23:59:59";
	}
	...
	public static void main(String[] args) throws Exception {
		List<Date> days = DateUtils.getDatesBetweenTwoDate(DateUtils.getdate("2013-01-09"),
				DateUtils.getdate("2013-01-11"));
